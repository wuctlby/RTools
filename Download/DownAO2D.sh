...
export Nr=32
export path="/alice/cern.ch/user/a/alihyperloop/jobs/0104/hy_1048711/AOD"
export localpath="/media/wuct/wulby/ALICE/AnRes/D0_flow/pass4/ML/DATA/3050/1"

alien.py cp -f -T $Nr ${path}/*AO2D.root file:$localpath

export Nr=32
export path="/alice/cern.ch/user/a/alihyperloop/jobs/0104/hy_1048711/AOD"
export localpath="/media/wuct/wulby/ALICE/AnRes/D0_flow/pass4/ML/DATA/3050/2"
