...
TARGET_DIR="/media/wuct/wulby/ALICE/AnRes/resolution/inputs/"
OUTPUT_BASE_DIR="/media/wuct/wulby/ALICE/AnRes/resolution/output_reso/k3050"
...
process_input_dir() {
    ...
    local analysis_results_path="$TARGET_DIR/AnalysisResults_${suffix}.root"

    # Step 2: Run the resolution
    python3 compute_reso.py "$analysis_results_path" -c "k3050" -o "$OUTPUT_BASE_DIR" -s "$suffix"
